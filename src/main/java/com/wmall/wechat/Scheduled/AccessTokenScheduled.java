package com.wmall.wechat.Scheduled;
...
public class AccessTokenScheduled {
    Logger logger = LoggerFactory.getLogger(AccessTokenScheduled.class);
    ...
    public void getAccessToken() throws Exception {
        ...
        WeChatConstant.corpToken = corpTokenInfo.getAccess_token();
